...
<body style="margin: 123px;padding: 15px;height: 675px;width: 670px;">
            ...
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Pembayaran</a>
                        <div class="dropdown-menu" role="menu">
                          <a class="dropdown-item" role="presentation" href="<?=base_url('siswa/siswa.php') ?>">Pembayaran SPP</a>
    ...
    <div class="row">
        <div class="col-md-12" style="height: 364px;margin: -3px;padding: -8px;">
            <div>
                <h1 style="height: 54px;margin: 36px;width: 735px;padding: -40px;">Daftar Pembayaran</h1>
            ...
            <div class="table-responsive" style="width: 1750px;height: 900px;margin-top: -124px;margin-bottom: 252px;padding: -40px;">
              <table class="table table-bordered table-striped" id="table1">
                    ...
                    <tbody>
                        <?php
                $no = 1;
                $sql_query = mysqli_query($con, "SELECT * FROM pembayaran") or die (mysqli_error($conn));
                while ($data = mysqli_fetch_array($sql_query )) { ?>
                    <tr>
                        ...
                        <br>
                        <td><a href="edit.php?id=<?=$data['id_pembayaran'];?>" style="color: rgb(57,20,204);">Edit</a></td>
                        <td><a href="hapus.php?id=<?=$data['id_pembayaran'];?>" onclick="return confirm('Yakin Hapus Data?')" style="color: rgb(187,40,40);">Hapus</a></td>
