...
$result = mysqli_query($con, "SELECT * FROM kelas WHERE id_kelas = '$id'"); 
...
<body style="margin: 173px;padding: -25px;height: 675px;width: 670px;">
    ...
    <div>
                <h1 style="height: 54px;margin: 36px;width: 1005px;padding: -60px;">Edit Data Kelas</h1>
            </div>
...
<div class="row">
  <div class="col-md-12" style="height: 504px;margin: 100px;padding: -10px;">
        ...
        <div class="form-group">
                ...
                <input type="text" name="id_kelas" value="<?=$data['id_kelas'] ?>" id="id_kelas" class="form-control" required autofocus>
            </div>
            <div class="form-group">
                <label for="nama_kelas">Nama Kelas</label>
                <input type="text" name="nama_kelas" value="<?=$data['nama_kelas'] ?>" id="nama_kelas" class="form-control" required>
            </div>
             <div class="form-group">
                <label for="kompetensi_keahlian">Kompetensi Keahlian</label>
                <input type="text" name="kompetensi_keahlian" value="<?=$data['kompetensi_keahlian'] ?>" id="kompetensi_keahlian" class="form-control" required>
            </div>
