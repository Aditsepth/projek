              ...
              <table class="table table-bordered table-striped" id="table1">
                ...
                while ($data = mysqli_fetch_array($sql_query )) { ?>
                    <tr>
                        ...
                        <td><?=$data['jns_cek']?></td>
                        <br>
                        <td><a href="edit.php?id=<?=$data['nisn'];?>" style="color: rgb(57,20,204);">Edit</a></td>
                        <td><a href="hapus.php?id=<?=$data['nisn'];?>" onclick="return confirm('Yakin Hapus Data?')" style="color: rgb(187,40,40);">Hapus</a></td>
