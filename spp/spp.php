...
<body style="margin: 123px;padding: 15px;height: 675px;width: 670px;">
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Pembayaran</a>
                        <div class="dropdown-menu" role="menu">
                          ...
                          <a class="dropdown-item" role="presentation" href="<?=base_url('siswa/siswa.php') ?>">Total SPP</a>
    ...
    <div class="row">
        <div class="col-md-12" style="height: 364px;margin: -3px;padding: -8px;">
            <div>
                <h2 style="height: 54px;margin: 36px;width: 735px;padding: -40px;">Daftar Total SPP</h2>
                <h1>Halo ,<b><?php echo $_SESSION['username']; ?></b> <br>Anda telah login sebagai </br> <b><?php echo $_SESSION['level']; ?></b>.</h1>
            </div>
              </div>
              </div>
            ...
            <div class="table-responsive" style="width: 1750px;height: 900px;margin-top: -124px;margin-bottom: 252px;padding: -40px;">
              <table class="table table-bordered table-striped" id="table1">
                    ...
                    <tbody>
                        <?php
                $no = 1;
                $sql_query = mysqli_query($con, "SELECT * FROM spp") or die (mysqli_error($conn));
                while ($data = mysqli_fetch_array($sql_query )) { ?>
                    <tr>
                        ...
                        <br>
                        <td><a href="edit.php?id=<?=$data['id_spp'];?>" style="color: rgb(57,20,204);">Edit</a></td>
                        <td><a href="hapus.php?id=<?=$data['id_spp'];?>" onclick="return confirm('Yakin Hapus Data?')" style="color: rgb(187,40,40);">Hapus</a></td>
                    </tr>
                <?php    
                }
            ?>
