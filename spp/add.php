...
<body style="margin: 173px;padding: -25px;height: 675px;width: 670px;">
    ...
    <div>
                <h1 style="height: 54px;margin: 36px;width: 1005px;padding: -60px;">Tambah Data SPP</h1>
            </div>
<div class="box-header">
<div class="pull-right">
                    <a href="spp.php" class="btn btn-warning btn-flat">
...
<div class="row">
  <div class="col-md-12" style="height: 504px;margin: 100px;padding: -10px;">
        ...
        <div class="form-group">
                ...
                <input type="text" name="id_spp" id="id_spp" class="form-control" required autofocus>
            </div>
            <div class="form-group">
        ...
        if(isset($_POST['submit'])){
            ...
            $cek = mysqli_query($con, "SELECT * FROM spp WHERE id_spp='$id_spp'") or die(mysqli_error($con));
            
            if(mysqli_num_rows($cek) == 0){
                $sql = mysqli_query($con, "INSERT INTO spp(id_spp, tahun, nominal) VALUES('$id_spp', '$tahun', '$nominal')") or die(mysqli_error($con));
                
                if($sql){
                    echo '<script>alert("Berhasil menambahkan data."); document.location="spp.php";</script>';
                }else{
