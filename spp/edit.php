...
$result = mysqli_query($con, "SELECT * FROM spp WHERE id_spp = '$id'"); 
...
<body style="margin: 173px;padding: -25px;height: 675px;width: 670px;">
    ...
    <div>
                <h1 style="height: 54px;margin: 36px;width: 1005px;padding: -60px;">Edit Data SPP</h1>
            </div>
...
<div class="row">
  <div class="col-md-12" style="height: 504px;margin: 100px;padding: -10px;">
        ...
        <div class="form-group">
                ...
                <input type="text" name="id_spp" value="<?=$data['id_spp'] ?>" id="id_spp" class="form-control" required autofocus>
            </div>
            <div class="form-group">
                <label for="tahun">Tahun</label>
                <input type="text" name="tahun" value="<?=$data['tahun'] ?>" id="tahun" class="form-control" required>
            </div>
             <div class="form-group">
                <label for="nominal">Nominal</label>
                <input type="text" name="nominal" value="<?=$data['nominal'] ?>" id="nominal" class="form-control" required>
            </div>
